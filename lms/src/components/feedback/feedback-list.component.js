...
const Feedback = props => (
    <tr className='bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600'>
        <td className='px-6 py-4'>{props.feedback.course}</td>
        <td className='px-6 py-4'>{props.feedback.student}</td>
        <td className='px-6 py-4'>{props.feedback.rating}</td>
...
export class FeedbackList extends Component {
    ...
    searchFeedbackList() {
        ...
        return this.state.feedback.map((currentfeedback) => {
            if (
                ...
                currentfeedback.course
            ) {
                return (
                    <tr className='bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600'>

                        <td className='px-6 py-4'>{currentfeedback.course}</td>
                        <td className='px-6 py-4'>{currentfeedback.student}</td>
                        <td className='px-6 py-4'>{currentfeedback.rating}</td>
    ...
    exportFeedback = () => {
        ...
        const headers = [["Course","Student","Feedback"]];
